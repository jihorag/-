...
dates = [
    "20250405", "20240323", "20230408", "20220402", "20210417",
    "20200711", "20190406", "20180407", "20170408", "20160409",
    "20150418", "20140419", "20130727", "20120407", "20110409"
]
...
def scrape_exam(date):
    url = f"https://cbtbank.kr/exam/we{date}"
...
def main():
    ...
    for date in dates:
        ...
        if any(q.get('exam') == '9급 국가직 공무원' and q.get('exam_date') == date_str for q in db):
