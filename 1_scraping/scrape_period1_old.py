...
dates = [
    "2015-06-27", "2014-07-05", "2013-06-29",
    "2012-07-01", "2011-07-03", "2010-07-04", "2009-07-05"
]
...
def scrape_exam(date_str):
    ...
    url = f"https://cbtbank.kr/exam/cen{date_code}"  # cen for old 1st period
...
if __name__ == '__main__':
    ...
    for d in dates:
        print(f"Scraping exam 1교시(구) for {d}...")
