...
- Produces:
  ...
  - `normalize(entry: object, prevList: object[]): object` — `rep`·`prevTs`·`score`·`v`를 채운 완성 레코드
...
Run: `cd viewer && npm test`
Expected: PASS — 97개 그대로 (JSX는 테스트 대상이 아니다)
