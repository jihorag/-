...
file_path = Path("/Users/hanjiho/Documents/감정평가사 기출문제/scratch/generate_conceptual_questions.py")
...
print("Successfully replaced all JSON literals with Python literals.")
