...
# Section 3 questions are index 2550 to 2600 (1-based Q2551 to Q2600)
sec3_questions = questions[2550:2600]

print(f"Total questions in database: {len(questions)}")
print(f"Loaded {len(sec3_questions)} questions for Section 3 verification.")
...
for i, q in enumerate(sec3_questions):
    ...
    # 1. ID Prefix
    if not q_id.startswith("practice-accounting-ch10s03-"):
        errors.append(f"Q{q_num}: ID '{q_id}' does not start with 'practice-accounting-ch10s03-'")
