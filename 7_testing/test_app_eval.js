...
const year2026 = processedData.filter(q => q.year === '2026');
const uSubs = new Set(year2026.map(q => q.unifiedSubject));
console.log('2026 Unified Subjects:', Array.from(uSubs));
const sSubs = new Set(year2026.map(q => q.subject));
console.log('2026 Subjects:', Array.from(sSubs));
