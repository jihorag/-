...
def main():
    ...
    tasks = [
        # 2017
        {"pdf": "기출문제/세무사/2017/1교시 A형.pdf", "year": "2017", "session": 1, "subjects": [("재정학", 1, 40)]},
        {"pdf": "기출문제/세무사/2017/2교시_A형_민법.pdf", "year": "2017", "session": 2, "subjects": [("회계학개론", 1, 40), ("민법", 41, 80)]},
        # 2016
        {"pdf": "기출문제/세무사/2016/시험지(1교시 A형).pdf", "year": "2016", "session": 1, "subjects": [("재정학", 1, 40)]},
        {"pdf": "기출문제/세무사/2016/회계학개론,민법(2교시 A형).pdf", "year": "2016", "session": 2, "subjects": [("회계학개론", 1, 40), ("민법", 41, 80)]},
        # 2015
        {"pdf": "기출문제/세무사/2015/2015년 세무사 1차 재정학 A형.pdf", "year": "2015", "session": 1, "subjects": [("재정학", 1, 40)]},
        {"pdf": "기출문제/세무사/2015/2015년 세무사 1차 회계학개론 A형.pdf", "year": "2015", "session": 2, "subjects": [("회계학개론", 1, 40)]},
        {"pdf": "기출문제/세무사/2015/2015년 세무사 1차 민법 A형.pdf", "year": "2015", "session": 2, "subjects": [("민법", 41, 80)]},
        # 2014
        {"pdf": "기출문제/세무사/2014/2014년 재정학A형.pdf", "year": "2014", "session": 1, "subjects": [("재정학", 1, 40)]},
        {"pdf": "기출문제/세무사/2014/2014년 회계학 A형.pdf", "year": "2014", "session": 2, "subjects": [("회계학개론", 1, 40)]},
        {"pdf": "기출문제/세무사/2014/2014년 민법A형.pdf", "year": "2014", "session": 2, "subjects": [("민법", 41, 80)]},
    ]
