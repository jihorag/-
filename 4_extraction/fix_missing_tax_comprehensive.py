...
def main():
    ...
    tasks = [
        # 2014 Missing
        {"pdf": "기출문제/세무사/2014/2014년 재정학A형.pdf", "year": "2014", "session": 1, "subjects": [("재정학", [20, 37])]},
        {"pdf": "기출문제/세무사/2014/2014년 회계학 A형.pdf", "year": "2014", "session": 2, "subjects": [("회계학개론", [27, 29])]},
        # 2015 Missing
        {"pdf": "기출문제/세무사/2015/2015년 세무사 1차 재정학 A형.pdf", "year": "2015", "session": 1, "subjects": [("재정학", [5])]},
        {"pdf": "기출문제/세무사/2015/2015년 세무사 1차 민법 A형.pdf", "year": "2015", "session": 2, "subjects": [("민법", [44])]},
        # 2024 Accounting (Entire)
        {"pdf": "기출문제/세무사/2024/2024년도 제61회 세무사 1차시험 2교시 시험지 원본(민법).pdf", "year": "2024", "session": 2, "subjects": [("회계학개론", list(range(1, 41)))]},
        # 2025 Accounting (Entire)
        {"pdf": "기출문제/세무사/2025/2025년도 제62회 세무사 1차시험 2교시 시험지 원본(민법).pdf", "year": "2025", "session": 2, "subjects": [("회계학개론", list(range(1, 41)))]},
        # 2026 Accounting (Entire)
        {"pdf": "기출문제/세무사/2026/2026년도 제63회 세무사 1차시험 2교시 시험지 원본(민법).pdf", "year": "2026", "session": 2, "subjects": [("회계학개론", list(range(1, 41)))]},
    ]
