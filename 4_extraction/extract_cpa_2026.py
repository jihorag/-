...
def main():
    ...
    tasks = [
        {"pdf": "기출문제/회계사/2026/1교시 경영학 경제원론(1형)_문제_2026.pdf", "year": "2026", "subjects": ["경제원론"]},
        {"pdf": "기출문제/회계사/2026/3교시 회계학(1형)_문제_2026.pdf", "year": "2026", "subjects": ["회계학"]}
    ]
