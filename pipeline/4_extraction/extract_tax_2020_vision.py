...
def main():
    ...
    tasks = [
        {"pdf": "sources/기출문제/세무사/2020/1교시 A형.pdf", "year": "2020", "session": 1, "subjects": ["재정학", "세법학개론"]},
        {"pdf": "sources/기출문제/세무사/2020/2교시 A형(선택과목 민법).pdf", "year": "2020", "session": 2, "subjects": ["회계학개론", "민법"]}
    ]
