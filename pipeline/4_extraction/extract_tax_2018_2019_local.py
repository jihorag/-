...
def main():
    ...
    tasks = [
        # 2019
        {"pdf": "sources/기출문제/세무사/2019/1교시 A형.pdf", "year": "2019", "session": 1, "subjects": [("재정학", 1, 40)]},
        {"pdf": "sources/기출문제/세무사/2019/2교시 B형(회계학개론, 민법).pdf", "year": "2019", "session": 2, "subjects": [("회계학개론", 1, 40), ("민법", 41, 80)]},
        # 2018
        {"pdf": "sources/기출문제/세무사/2018/2018 세무사 1차 1교시 A형.pdf", "year": "2018", "session": 1, "subjects": [("재정학", 1, 40)]},
        {"pdf": "sources/기출문제/세무사/2018/2018 세무사 1차 2교시 A형(민법).pdf", "year": "2018", "session": 2, "subjects": [("회계학개론", 1, 40), ("민법", 41, 80)]},
    ]
