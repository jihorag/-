...
IMG_SRC_DIR = "/Users/jiho/감정평가사 sources/기출문제/기출문제/회계사/2022/경제학"
IMG_DEST_DIR = "images"
ANS_PDF = "/Users/jiho/감정평가사 sources/기출문제/기출문제/회계사/2022/_정답_2022.pdf"
...
def main():
    ...
    img_files = [f for f in os.listdir(IMG_SRC_DIR) if f.endswith(".png") and "스크린샷" in f]
