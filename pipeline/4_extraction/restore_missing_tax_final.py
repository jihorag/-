...
if __name__ == "__main__":
    restore_specific_vision("2018", "재정학", 40, "sources/기출문제/세무사/2018/2018 세무사 1차 1교시 A형.pdf", page_hint=10) # Try page 11 (index 10)
    restore_specific_vision("2018", "회계학개론", 22, "sources/기출문제/세무사/2018/2018 세무사 1차 2교시 A형(민법).pdf", page_hint=6) # Try page 7 (index 6)
