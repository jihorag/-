...
사용:
  python3 pipeline/5_vision/png_to_webp.py           # 변환만
  python3 pipeline/5_vision/png_to_webp.py --prune-unused   # 미참조 파일 먼저 제거
  python3 pipeline/5_vision/png_to_webp.py --drop-png       # 변환 후 public 의 .png 제거
