...
dates = [
    "20200627", "20190323", "20180324", "20170325", "20160402",
    "20150411", "20140412", "20130413", "20120408", "20110410",
    "20100404"
]
...
def scrape_exam(date):
    url = f"https://cbtbank.kr/exam/cgx{date}"
...
def main():
    ...
    for date in dates:
        ...
        if any(q.get('exam') == '관세사' and q.get('exam_date') == date_str for q in db):
